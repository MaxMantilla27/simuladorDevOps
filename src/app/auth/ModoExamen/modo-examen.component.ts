...
import { ExamenIntentoDTO, RegistroDevOpExamenDTO } from 'src/app/Models/ExamenDTO';
...
export class ModoExamenComponent implements OnInit {
  ...
  public RegistrarExamenEnvio:RegistroDevOpExamenDTO={
    id:0,
    ...
    this._ExamenService.ListaExamenesIncompletos().subscribe({
      next:(x)=>{
        ...
        this.SimulacionesIncompletas.forEach((y:any)=>{
          if(y.idEstadoExamen!=3 && y.idSimuladorDevOpModo==3){
