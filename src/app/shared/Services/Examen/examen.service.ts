...
import { RegistroDevOpExamenDTO, RegistroDevOpExamenRespuestaDTO } from 'src/app/Models/ExamenDTO';
...
export class ExamenService {
  ...
  public Registrar(Json:RegistroDevOpExamenDTO):Observable<any>{
  ...
  public RegistrarRespuestaSeleccion(Json:RegistroDevOpExamenRespuestaDTO):Observable<any>{
  ...
  public ObtenerMejorExamenPorUsuario(Json:RegistroDevOpExamenDTO):Observable<any>{
